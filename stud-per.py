...
def main():
    ...
    hour_sutdied = st.number_input("Hour studied",min_value=1,max_value=10,value=5)
    ...
    sleeping_hour = st.number_input("Sleepin hours",min_value=4,max_value=10,value = 7)
